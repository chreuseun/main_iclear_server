...
//componets TRADIONAL
import ManageDeptRequirements from '../menuMyDepartments/components/manageDeptRequirement/manageDeptRequirements' 


const NavbarUser = (props) => {
    console.log('ManageDeptRequirements:  ','useEffect - Data');
    ...
    // to change path push from th child component
        ...
        <React.Fragment>
            ...
            <BrowserRouter>
                ...
                <Container   style={{marginTop:"100px", padding:'20px'}}>
                    ...
                    <ManageDeptRequirements pushToLink={pushToLink} userDetails={userDetails} />
