...
//componets TRADIONAL
import SelectedDepartment from '../menuMyDepartments/components/SelectedDepartment'  // '../../../pages/protected/menu/menuUser/menuMyDepartments/SelectionMyDepartments'
...
const NavbarUser = (props) => {
    ...
    useEffect(()=>{
        ...
        console.log('nav - selectedDepartments:  ','useEffect - Data');
        ...
        <React.Fragment>
            ...
            <BrowserRouter>
                ...
                <Container   style={{marginTop:"100px", padding:'20px'}}>
                    ...
                    <SelectedDepartment pushToLink={pushToLink} userDetails={userDetails} />
