...
//componets TRADIONAL
import MenuDepartmentClearance from '../menuDepartmentClearance/menuDepartmentClearance';
        ...
        <React.Fragment>
            ...
            <BrowserRouter>
                ...
                <Container   style={{marginTop:"100px", padding:'20px'}}>
                    <MenuDepartmentClearance pushToLink={pushToLink} userDetails={userDetails} />
                </Container>
            </BrowserRouter>
