...
//componets TRADIONAL
import VioDeptSettings  from '../menuViolation/components/SelectedVioDept/components/VioDeptSettings/VioDepSettings'  // '../../../pages/protected/menu/menuUser/menuMyDepartments/SelectionMyDepartments'
        ...
        <React.Fragment>
            ...
            <BrowserRouter>
                ...
                <Container   style={{marginTop:"100px", padding:'20px'}}>
                    <VioDeptSettings pushToLink={pushToLink} userDetails={userDetails} />
                </Container>
            </BrowserRouter>
