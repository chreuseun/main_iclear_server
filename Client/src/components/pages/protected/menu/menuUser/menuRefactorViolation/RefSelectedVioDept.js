...
//componets TRADIONAL
import SelectedVioDept from '../menuViolation/components/SelectedVioDept/SelectedVioDept'  // '../../../pages/protected/menu/menuUser/menuMyDepartments/SelectionMyDepartments'
        ...
        <React.Fragment>
            ...
            <BrowserRouter>
                ...
                <Container   style={{marginTop:"100px", padding:'20px'}}>
                    <SelectedVioDept pushToLink={pushToLink} userDetails={userDetails} />
                </Container>
            </BrowserRouter>
