...
//componets TRADIONAL
import MainViolation from '../menuViolation/MainViolation'  // '../../../pages/protected/menu/menuUser/menuMyDepartments/SelectionMyDepartments'
...
const NavbarUser = (props) => {
    ...
    const pushToLink = (push) => {
        ...
        console.log('RefMainViolation.js - ', push)
        history.push(push)
    }
        ...
        <React.Fragment>
            ...
            <BrowserRouter>
                ...
                <Container   style={{marginTop:"100px", padding:'20px'}}>
                    <MainViolation pushToLink={pushToLink} userDetails={userDetails} />
                </Container>
            </BrowserRouter>
